				...
				<div class="banner-textt">
					<form method="post" class="form-inline">
						<div class="form-group mb-2">
							<label for="staticEmail2">Proprietaire</label>
						</div>
						<div class="form-group mx-sm-3 mb-2">
							<input type="text" class="form-control" name="prop" placeholder="Proprietaire">
						</div>
					...
					<fieldset style="background-color: rgba(0, 0, 0 ,0.50)">
						<legend>
							<a href="index.html" class="logo" >Liste des avions par type</a>
						</legend>
						<?php
						try {
							...
							$req = "SELECT * from avion where Nom_Proprietaire='$choix'";
							$rep = $conn->query($req);
							if ($rep) {
